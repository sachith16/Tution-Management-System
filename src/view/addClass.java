...
public class addClass extends javax.swing.JFrame {
    ...
    private void subdb() {
        try {
            ...
            JOptionPane.showMessageDialog(addClass.this, ex.getMessage());
...
//        numberf.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 51, 51)));
        ...
        for (int row = 0; row < rowc; row++) {
            ...
            try {
                count++;
                boolean isAdded = classController.addClass(Mod);
                if (isAdded) {
                    b = true;
                } else {
                    JOptionPane.showMessageDialog(addClass.this, count + " adding failed");
                    c = true;
                }
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(addClass.this, ex.getMessage());
...
////////////////////////////////////////
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        updateClass upT = new updateClass();
        upT.setVisible(true);
        this.dispose();
