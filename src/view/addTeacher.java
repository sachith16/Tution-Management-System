...
public class addTeacher extends javax.swing.JFrame {
    ...
    private void scoolcdb() {
        try {
            ...
            JOptionPane.showMessageDialog(addTeacher.this, ex.getMessage());
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(1100, 500, 70, 23));
...
//                stm.setObject(4, codgr);
//                stm.setObject(5, coad);
//                stm.setObject(6, cograde);
//                stm.setObject(7, cosub);
//                stm.setObject(3, cosch);
//                stm.setObject(8, comob);
//                stm.setObject(9, cohome);
...
//
//                } else {
//                    JOptionPane.showMessageDialog(addTeacher.this, "Record " + count + " Adding failed");
//                    c = true;
//                }
//
...
//            mod.setRowCount(0);
//            if (c == true) {
//                JOptionPane.showMessageDialog(addTeacher.this, "Other records added successfully");
//            } else {
//                JOptionPane.showMessageDialog(addTeacher.this, "Added successfully");
//            }
//        }
//        numberf.requestFocus();
//        numberf.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 51, 51)));
        ...
        for (int row = 0; row < rowc; row++) {
            ...
            try {
                boolean isAdded = teacherController.addTeacher(tchrMod);
                if (isAdded) {
                    b = true;
                } else {
                    JOptionPane.showMessageDialog(addTeacher.this, count + " adding failed");
                    c = true;
                }
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(addTeacher.this, ex.getMessage());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            b1 = teacherController.searchID(numberf.getText());
        ...
        if (ad1f.getText().isEmpty()) {
            emptyf = emptyf + "Address,";
        }
        if (gradesf.getText().isEmpty()) {
            emptyf = emptyf + "Grades,";
        }
        if (subsf.getText().isEmpty()) {
            emptyf = emptyf + "Subjects,";
        }
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        updateTeacher upT = new updateTeacher();
        upT.setVisible(true);
        this.dispose();
