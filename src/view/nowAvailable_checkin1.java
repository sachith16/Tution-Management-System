 ...
 * @author sachee
 */
public class nowAvailable_checkin1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        minl1.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        minl1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        minl1.setText("PM");
        jPanel1.add(minl1, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 60, 50, 20));

        minl.setFont(new java.awt.Font("Calibri", 0, 24)); // NOI18N
        minl.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        minl.setText("20");
        jPanel1.add(minl, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 44, 50, 20));

        hourl.setFont(new java.awt.Font("Calibri", 0, 24)); // NOI18N
        hourl.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        hourl.setText("12");
        jPanel1.add(hourl, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 24, 50, 20));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/Entypo_d83d(0)_32_1.png"))); // NOI18N
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/Entypo_e75e(0)_28.png"))); // NOI18N
    ...
    private void jLabel1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseEntered
        ImageIcon I = new ImageIcon(getClass().getResource("Entypo_d83d(0)_32_2.png"));
        jLabel1.setIcon(I);
    }//GEN-LAST:event_jLabel1MouseEntered

    private void jLabel1MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseExited
        ImageIcon I = new ImageIcon(getClass().getResource("Entypo_d83d(0)_32_1.png"));
        jLabel1.setIcon(I);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (index >= 0) {
            ...
            try {
                ...
                if (res >= 0) {
                        checkinCounter new1=new checkinCounter(conumber, tablename,dayst[0],dayst[1],dayst[2],dayst[3],dayst[4]);
                        new1.setVisible(true);
                } else {
                    JOptionPane.showMessageDialog(nowAvailable_checkin1.this, "Error");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nowAvailable_checkin1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new nowAvailable_checkin1().setVisible(true);
            }
        });
    }
