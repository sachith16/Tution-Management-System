 ...
 * @author sachee
 */
public class viewClassFreeHalf extends javax.swing.JFrame {
    ...
    private void subdb() {
        try {
            ...
            JOptionPane.showMessageDialog(viewClassFreeHalf.this, ex.getMessage());
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1060, 20, 110, 80));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1070, 500, -1, 23));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (index >= 0) {
            ...
            freeHalf new1 = new freeHalf(conumber);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewClassFreeHalf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
