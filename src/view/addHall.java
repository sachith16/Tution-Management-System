...
public class addHall extends javax.swing.JFrame {
    ...
    public addHall(JComboBox adGrd) {
        initComponents();
    ...
    public void searchm2() {
        ...
        try {
            comboModel[] clsM = controller.otherController.viewName("Hall");
            ...
            JOptionPane.showMessageDialog(addHall.this, ex.getMessage());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (!jTextField1.getText().isEmpty()) {
            try {
                boolean isAdded = otherController.addName("Hall", jTextField1.getText());

                if (isAdded) {
                    JOptionPane.showMessageDialog(addHall.this, "Added successfully");
                    if (adGrd != null) {
                    ...
                    JOptionPane.showMessageDialog(addHall.this, "Adding failed");
                }
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(addHall.this, ex.getMessage());
            } catch (ClassNotFoundException ex) {
            ...
            JOptionPane.showMessageDialog(addHall.this, "Field is empty");
        }
            ...
            if (index >= 0) {
                ...
                item.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        try {
                            boolean isAdded = otherController.deleteName("Hall", conumber);

                            if (isAdded) {
                                JOptionPane.showMessageDialog(addHall.this, "Record deleted successfully");

                            } else {
                                JOptionPane.showMessageDialog(addHall.this, "Record deleting failed");
                            }
                        } catch (SQLException ex) {
                            JOptionPane.showMessageDialog(addHall.this, ex.getMessage());
                        } catch (ClassNotFoundException ex) {
