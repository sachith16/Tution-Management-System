...
public class viewClass extends javax.swing.JFrame {
    ...
    private void subdb() {
        try {
            ...
            JOptionPane.showMessageDialog(viewClass.this, ex.getMessage());
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 500, 120, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/classlog2.png"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(945, 20, 110, 80));
        ...
        jButton1.setText("Date changes");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton1ActionPerformed(evt);
            }
        });
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(925, 500, 120, -1));

        jButton2.setText("View extra classes");
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton2ActionPerformed(evt);
            }
        });
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(675, 500, 120, -1));

        jButton3.setText("Add extra classes");
        jButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton3ActionPerformed(evt);
            }
        });
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 500, 120, -1));
    ...
    public void searchm() {
        ...
        String date_s = "";
        if (datecb.isSelected()) {
            date_s = datec.getItemAt(datec.getSelectedIndex());
        }
        String grade_s = "";
        ...
        classModel Mod = new classModel(nums, sub_s, grade_s, date_s, tchr_s, times_s, timee_s, "", hall_s);

       try {
            classModel[] clsM = controller.classController.viewClass(Mod);

            for (int i = 0; i < clsM.length; i++) {
                String rowmod[] = {clsM[i].getClassID(), clsM[i].getSubject(), clsM[i].getTeacher(), clsM[i].getGrade(),
                    clsM[i].getDate(), clsM[i].getTimeStart(), clsM[i].getTimeEnd(),
                    clsM[i].getFee(), clsM[i].getHallNo()};
                mod.addRow(rowmod);
            }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (index >= 0) {
            ...
            String codate = (String) jTable1.getValueAt(index, 4);
            new viewAttendance(conumber, codate).setVisible(true);
        }
            ...
            if (index >= 0) {
                ...
                item.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                       updateClass n=new updateClass(conumber);
                       n.setVisible(true);
                       n.updateBtn();
                    }
                });
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       int index = jTable1.getSelectedRow();
        if (index >= 0) {
            String conumber = (String) jTable1.getValueAt(index, 0);
            String codate = (String) jTable1.getValueAt(index, 4);
            new changeClass(conumber, codate).setVisible(true);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (index >= 0) {
            String conumber = (String) jTable1.getValueAt(index, 0);
            String codate = (String) jTable1.getValueAt(index, 4);
            new viewExtraAt(conumber).setVisible(true);
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (index >= 0) {
            String conumber = (String) jTable1.getValueAt(index, 0);
            String codate = (String) jTable1.getValueAt(index, 4);
            new extraClass(conumber, codate).setVisible(true);
        }
