...
public class addGrade extends javax.swing.JFrame {
    ...
    public addGrade(JComboBox adGrd) {
        initComponents();
    ...
    public void searchm2() {
        ...
        try {
            comboModel[] clsM = controller.otherController.viewName("Grade");
            ...
            JOptionPane.showMessageDialog(addGrade.this, ex.getMessage());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (!jTextField1.getText().isEmpty()) {
            try {
                boolean isAdded = otherController.addName("Grade", jTextField1.getText());

                if (isAdded) {
                    JOptionPane.showMessageDialog(addGrade.this, "Added successfully");
                    if (adGrd != null) {
                    ...
                    JOptionPane.showMessageDialog(addGrade.this, "Adding failed");
                }
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(addGrade.this, ex.getMessage());
            } catch (ClassNotFoundException ex) {
            ...
            JOptionPane.showMessageDialog(addGrade.this, "Field is empty");
        }
            ...
            if (index >= 0) {
                ...
                item.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        try {
                            boolean isAdded = otherController.deleteName("Grade", conumber);

                            if (isAdded) {
                                JOptionPane.showMessageDialog(addGrade.this, "Record deleted successfully");

                            } else {
                                JOptionPane.showMessageDialog(addGrade.this, "Record deleting failed");
                            }
                        } catch (SQLException ex) {
                            JOptionPane.showMessageDialog(addGrade.this, ex.getMessage());
                        } catch (ClassNotFoundException ex) {
