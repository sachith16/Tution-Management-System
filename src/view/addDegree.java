...
public class addDegree extends javax.swing.JFrame {
    ...
    public addDegree(JComboBox adGrd) {
        initComponents();
    ...
    public void searchm2() {
        ...
        try {
            comboModel[] clsM = controller.otherController.viewName("Degree");
            ...
            JOptionPane.showMessageDialog(addDegree.this, ex.getMessage());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Degree abreviation");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (!jTextField1.getText().isEmpty()) {
            try {
                boolean isAdded = otherController.addName("Degree", jTextField1.getText());

                if (isAdded) {
                    JOptionPane.showMessageDialog(addDegree.this, "Added successfully");
                    if (adGrd != null) {
                    ...
                    JOptionPane.showMessageDialog(addDegree.this, "Adding failed");
                }
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(addDegree.this, ex.getMessage());
            } catch (ClassNotFoundException ex) {
            ...
            JOptionPane.showMessageDialog(addDegree.this, "Field is empty");
        }
            ...
            if (index >= 0) {
                ...
                item.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        try {
                            boolean isAdded = otherController.deleteName("Degree", conumber);

                            if (isAdded) {
                                JOptionPane.showMessageDialog(addDegree.this, "Record deleted successfully");

                            } else {
                                JOptionPane.showMessageDialog(addDegree.this, "Record deleting failed");
                            }
                        } catch (SQLException ex) {
                            JOptionPane.showMessageDialog(addDegree.this, ex.getMessage());
                        } catch (ClassNotFoundException ex) {
