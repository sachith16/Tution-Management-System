...
public class updateExam extends javax.swing.JFrame {
    ...
    private void subdb() {
        try {
            ...
            JOptionPane.showMessageDialog(updateExam.this, ex.getMessage());
    ...
    public void updateBtn() {
        ...
        try {
            if (controller.examController.searchExam(numberf.getText()) != null) {
                examModel Mod = controller.examController.searchExam(numberf.getText());
                ...
                try {
                    t = ft2.parse(Mod.getDate());
                    Calendar cal = Calendar.getInstance();
                    //cal.setTime(t);
                    int year = Integer.parseInt((String) Mod.getDate().subSequence(0, 4));
                    int month = Integer.parseInt((String) Mod.getDate().subSequence(5, 7));
                    int day = Integer.parseInt((String) Mod.getDate().subSequence(8, 10));
                    cal.set(year, month - 1, day);
                    datec.setSelectedDate(cal);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 80, 90, -1));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        for (int row = 0; row < rowc; row++) {
            ...
            try {
                count++;
                boolean isAdded = examController.updateExam(Mod);
                if (isAdded) {
                    b = true;
                } else {
                    JOptionPane.showMessageDialog(updateExam.this, count + " adding failed");
                    c = true;
                }
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(updateExam.this, ex.getMessage());
        ...
        if (b == true) {
            ...
            if (c == true) {
                JOptionPane.showMessageDialog(updateExam.this, "Other records added successfully");
            } else {
                JOptionPane.showMessageDialog(updateExam.this, "Added successfully");
                mod.setRowCount(0);
            }
        }
...
////////////////////////////////////////
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            boolean isAdded = examController.deleteExam(numberf.getText());
            if (isAdded) {
                JOptionPane.showMessageDialog(updateExam.this, "Record deleted successfully");
            } else {
                JOptionPane.showMessageDialog(updateExam.this, "Record deleting failed");
